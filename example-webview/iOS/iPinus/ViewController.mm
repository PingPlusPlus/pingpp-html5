...
#define kUrl        @"YOUR-SERVER-SDK-URL"
#define kWebUrl     @"YOUR-WEBPAGE-URL"
...
- (BOOL)webView:(UIWebView *)webView shouldStartLoadWithRequest:(NSURLRequest *)request navigationType:(UIWebViewNavigationType)navigationType
{
    ...
    if ([requestString hasPrefix:protocol]) {
        ...
        NSMutableDictionary *queryStringDict = [[[NSMutableDictionary alloc] init] autorelease];
...
- (void)connectionDidFinishLoading:(NSURLConnection *)connection
{
    ...
    {
        [Pingpp createPayment:data viewController:self appURLScheme:kUrlScheme delegate:(AppDelegate*)[[UIApplication sharedApplication] delegate]];
    }
    [data release];
    [connection release];
    connection = nil;
